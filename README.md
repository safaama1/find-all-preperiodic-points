...
**_Input of the algorithm_:**<br/> A dynamical system defined over 𝑭𝒒(𝒕) (function fields) where 𝑭 is a finite field .<br/>
**_Output of the algorithm_:** <br/>List of all preperiodic points of the dynamical system.
